  ...
  return (
    <LegalLayout>
      <div className="bg-card rounded-2xl shadow-sm border border-border p-8 md:p-12">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-foreground">Condiciones del Servicio</h1>
        ...
        <div className="space-y-8 text-[15px] leading-relaxed text-muted-foreground">
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">1. Aceptación de los términos</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">3. Registro y cuentas</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">4. Uso aceptable</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">5. Políticas de mensajería</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">6. Propiedad intelectual</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">7. Privacidad y protección de datos</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">8. Disponibilidad del servicio</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">9. Limitación de responsabilidad</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">10. Indemnización</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">11. Terminación</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">12. Modificaciones</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">13. Ley aplicable y jurisdicción</h2>
            <p>
