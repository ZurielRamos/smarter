    ...
    <LegalLayout>
      <div className="bg-card rounded-2xl shadow-sm border border-border p-8 md:p-12">
        <div className="mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">Instrucciones para solicitar la eliminación de tus datos personales</p>
        </div>

        <div className="space-y-8 text-[15px] leading-relaxed text-muted-foreground">
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">Tus derechos</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">¿Qué datos se eliminan?</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">Opción 1: Solicitud por correo electrónico</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">Opción 2: Formulario de solicitud</h2>
            <p className="mb-4">
            ...
            {!submitted ? (
              <div className="bg-muted rounded-xl p-6 border border-border">
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-foreground mb-1.5">Motivo <span className="text-muted-foreground font-normal">(opcional)</span></label>
                    <textarea
                      value={reason}
                  ...
                  <div className="pt-2">
                    ...
                    <p className="text-xs text-muted-foreground mt-2">Al enviar, confirmas que eres el titular de los datos o estás autorizado para realizar esta solicitud.</p>
                  </div>
                </div>
              </div>
            ) : (
          ...
          <section>
            <h2 className="text-base font-semibold text-foreground mb-3">Proceso de eliminación</h2>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-foreground text-sm">Recepción de la solicitud</p>
                  <p className="text-sm text-muted-foreground">Verificamos tu identidad como titular de los datos</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-foreground text-sm">Confirmación</p>
                  <p className="text-sm text-muted-foreground">Te enviamos un correo confirmando que hemos recibido la solicitud</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-foreground text-sm">Procesamiento</p>
                  <p className="text-sm text-muted-foreground">Eliminamos todos tus datos personales de nuestros sistemas (máximo 30 días)</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-foreground text-sm">Notificación final</p>
                  <p className="text-sm text-muted-foreground">Te confirmamos por correo que la eliminación se ha completado</p>
                </div>
              </div>
            </div>
          </section>
