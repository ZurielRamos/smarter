  ...
  "campaignId": "p1q2r3s4-t5u6-7890-abcd-ef1234567890"
      ...
      },
      {
        id: "conversions", label: "Conversiones", endpoints: [
          { id: "create-event", method: "POST", label: "Crear evento de conversión", path: "/api/v1/{cuenta}/contact-events", description: "Registra un evento de conversión para un contacto. Si el contacto tiene atribución de ads activa, se notifica automáticamente a las plataformas conectadas (Meta, Google Ads, TikTok).", body: `{\n  "recordId": "uuid-del-contacto",\n  "type": "purchase",\n  "name": "Compra Plan Premium",\n  "value": 500000,\n  "currency": "COP",\n  "metadata": {\n    "productId": "plan-premium",\n    "orderId": "ORD-001"\n  }\n}`, params: [{ name: "type", type: "string", required: true, description: "Tipo: purchase, appointment, demo, qualified, proposal, registration, subscription, custom" }, { name: "recordId", type: "uuid", required: true, description: "ID del contacto" }, { name: "name", type: "string", required: true, description: "Nombre descriptivo del evento" }, { name: "value", type: "number", required: false, description: "Valor monetario (se reporta a ads si está configurado)" }, { name: "currency", type: "string", required: false, description: "Moneda: COP, USD, EUR, MXN. Default: COP" }], response: `{\n  "id": "uuid",\n  "tenantId": "uuid",\n  "recordId": "uuid",\n  "type": "purchase",\n  "name": "Compra Plan Premium",\n  "value": 500000,\n  "currency": "COP",\n  "source": "api",\n  "dispatched": true,\n  "dispatchedAt": "2026-08-05T18:30:00.000Z",\n  "createdAt": "2026-08-05T18:30:00.000Z"\n}` },
          { id: "list-events", method: "GET", label: "Listar eventos de un contacto", path: "/api/v1/{cuenta}/contact-events", description: "Obtiene el historial de eventos de conversión de un contacto.", params: [{ name: "recordId", type: "uuid", required: true, description: "ID del contacto" }, { name: "limit", type: "number", required: false, description: "Máximo de resultados (default 50)" }, { name: "offset", type: "number", required: false, description: "Offset para paginación" }], response: `{\n  "data": [\n    {\n      "id": "uuid",\n      "type": "purchase",\n      "name": "Compra Plan Premium",\n      "value": 500000,\n      "currency": "COP",\n      "source": "api",\n      "dispatched": true,\n      "createdAt": "2026-08-05T18:30:00.000Z"\n    }\n  ],\n  "total": 1\n}` },
        ],
      },
    ],
  },
