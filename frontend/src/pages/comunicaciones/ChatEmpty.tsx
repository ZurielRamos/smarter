    ...
    <div className="flex-1 flex items-center justify-center bg-background">
      <div className="text-center">
        <div className="relative mx-auto mb-6 w-32 h-32">
          ...
          {/* Main chat bubble */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-12 rounded-2xl bg-muted-foreground/30 flex items-center justify-center">
        ...
        <p className="text-muted-foreground text-sm font-medium">Por favor, selecciona una conversación del panel izquierdo</p>
      </div>
    </div>
  );
}
