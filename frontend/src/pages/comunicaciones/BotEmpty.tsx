  ...
  return (
    <div className="flex-1 flex items-center justify-center bg-background">
      <div className="text-center">
        ...
        <p className="text-muted-foreground text-sm font-medium">Selecciona un bot del panel izquierdo</p>
        <p className="text-muted-foreground/70 text-xs mt-1">O crea uno nuevo para empezar</p>
      </div>
    </div>
  );
}
