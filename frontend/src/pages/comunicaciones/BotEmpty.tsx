  ...
  return (
    <div className="flex-1 flex items-center justify-center bg-gray-50">
      <div className="text-center">
        ...
        <p className="text-gray-500 text-sm font-medium">Selecciona un bot del panel izquierdo</p>
        <p className="text-gray-400 text-xs mt-1">O crea uno nuevo para empezar</p>
      </div>
    </div>
  );
}
